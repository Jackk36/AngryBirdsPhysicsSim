...
# bear_image = pygame.image.load("/Users/jack_goode/PycharmProjects/AngryBirdsPhysicsSim/cuteBear.png")  # Bear button image
# bear_rect = bear_image.get_rect(topleft=(0, 5))  # Position the bear button on screen
# Button = Bear(False)
...
# sound_playing = not Button.is_sound_0n()  # Flag to track sound state
# if (not Button.is_sound_0n()):
#     pygame.mixer.Sound.play(sound, -1)  # Play sound in a loop initially
...
#     if sound_playing:
#         pygame.mixer.Sound.stop(sound)  # Stop sound
#     else:
#         pygame.mixer.Sound.play(sound, -1)  # Play sound (loop indefinitely)
#     sound_playing = not sound_playing  # Toggle the state
# def bear_button_clicked(mouse_pos):
#     return bear_rect.collidepoint(mouse_pos)
#
